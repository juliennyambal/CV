...
{\begin{itemize}%
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item Built Machine Learning models to use in the process, and integration in the pipeline.This involved fine-tuning and recalibrating the model given the users feedback, investigating for better models for the inference,
