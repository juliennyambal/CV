...
{}
{
		...
		\begin{itemize}%
			\item \textbf{Project Description}: For the new Capitec Business Bank, assist Decision Scientists into deploying their Machine Learning Based systems to production. 
			\item \textbf{Responsibilities}:
				\begin{itemize}
					\item Review codebase,
